...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                int row=database.delete(TodoNote.TABLE_NAME,TodoNote._ID+"=?",new String[]{note.id+""});
                if(row>0)   notesAdapter.refresh(loadNotesFromDatabase());
            }
            ...
            public void updateNote(Note note) {
                ...
                int row=database.update(TodoNote.TABLE_NAME,values,TodoNote._ID+"=?",new String[]{note.id+""});
                if(row>0)   notesAdapter.refresh(loadNotesFromDatabase());
            }
        });
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        String sortOrder= String.format(" %s desc, %s asc",TodoNote.COLUMN_PRIORITY,TodoNote._ID);;
